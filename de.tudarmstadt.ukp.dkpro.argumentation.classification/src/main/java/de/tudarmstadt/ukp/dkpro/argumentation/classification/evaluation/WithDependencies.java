...
import de.tudarmstadt.ukp.dkpro.argumentation.classification.features.lexical.MultipleCapitalLetters;
...
import de.tudarmstadt.ukp.dkpro.argumentation.classification.features.sentiment.SentimentFluctuationBinary;
    ...
    extends AbstractEvaluationScenario
{
    ...
    Dimension<List<Object>> getPipelineParameters()
    {
        ...
        return Dimension.create(
                DIM_PIPELINE_PARAMS,
                Arrays.asList(new Object[] { LuceneNgramFeatureExtractorBase.PARAM_NGRAM_MIN_N, 1,
                        LuceneNgramFeatureExtractorBase.PARAM_NGRAM_MAX_N, 3,
                        LuceneNgramFeatureExtractorBase.PARAM_NGRAM_USE_TOP_K, "10000",
                        ProductionRules.PARAM_NUMBER_OF_PRODRULES, "5000"
    ...
    Dimension<List<String>> getFeatureSets()
    {
        return Dimension.create(
                ...
                Arrays.asList(new String[] { LuceneNGramDFE.class.getName(),
                        ...
                        SimpleSentenceExtractor.class.getName(), SubClausesRatio.class.getName(),
                        FirstPersonInArgumentComponent.class.getName(),
                        DocStatFeature.class.getName(), PunctuationFeature.class.getName(),
                        MultipleCapitalLetters.class.getName(),
                        SentimentCoefficientsFeature.class.getName(),
                        SentimentFluctuationBinary.class.getName(),
