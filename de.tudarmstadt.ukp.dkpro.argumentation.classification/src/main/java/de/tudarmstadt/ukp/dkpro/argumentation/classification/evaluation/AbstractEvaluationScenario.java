    ...
    implements Constants
{
    ...
    /**
     * Run a cross validation on all the data. Use to set up the reader, the classifier, the
     * pipeline, ect... Use
     *
     */
     ...
     *
     * @param docTopic
     *            test domain for cross domain scenario or domain for in-domain CV; can be null for
     *            all data
     * @param classificationType
     *            cross validation / cross domain
     * @return param space
     */
...
//                Dimension.createBundle("featureSelection",dimFeatureSelection));
     ...
     *            domain (can be null for all domains)
        ...
        throws Exception
    {
        ...
        if (documentDomain == null) {
            ...
            batch = new BatchTaskCrossValidation("Experiment_Cross_Validation_In_Domain_"
                    + documentDomain.toString(), getPreprocessing(), numFolds);
        }
        batch.addInnerReport(ClassificationReport.class);
        batch.setParameterSpace(pSpace);
        batch.setExecutionPolicy(BatchTask.ExecutionPolicy.USE_EXISTING);
        batch.addReport(BatchOutcomeIDReport.class);
        batch.addReport(BatchCrossValidationReport.class);
        batch.addReport(BatchReportFMeasure.class);
//        batch.addReport(BatchFeatureSelection.class);
        ...
        throws Exception
    {
        ...
        BatchTaskTrainTest batch = new BatchTaskTrainTest("Experiment_Cross_Domain_"
                + documentDomain.toString(), getPreprocessing());
        batch.addInnerReport(ClassificationReport.class);
        batch.setParameterSpace(pSpace);
        batch.setExecutionPolicy(BatchTask.ExecutionPolicy.USE_EXISTING);
        ...
        throws ResourceInitializationException
    {
        ...
        return createEngineDescription(
                ...
                createEngineDescription(XmiWriter.class, XmiWriter.PARAM_TARGET_LOCATION, "output",
    ...
    {
        CROSS_VALIDATION, CROSS_DOMAIN_TRAIN_TEST
    }
