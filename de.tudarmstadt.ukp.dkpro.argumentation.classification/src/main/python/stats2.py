...
# Defining labels
classes = ['P1', 'P2']
domain = ['redshirting', 'prayer-in-schools', 'homeschooling', 'single-sex-education', 'mainstreaming', 'public-private-schools']
source = ['artcomment', 'forumpost']
list_file = os.listdir("/home/ukp-hiwi/workspace/de.tudarmstadt.ukp.dkpro.argumentation.classification/src/main/resources/gold_data/")
# Enter the directory containing P1 files
list_file_P1 = os.listdir("/home/ukp-hiwi/workspace/de.tudarmstadt.ukp.dkpro.argumentation.classification/src/main/resources/gold_data/")
...
list_file_P2 = os.listdir("/home/ukp-hiwi/workspace/de.tudarmstadt.ukp.dkpro.argumentation.classification/src/main/resources/gold_data/")
...
for do in domain:
	print "========= THE DOMAIN: "+ do.upper() + " ========="
	for cl in classes:
		print "====== THE CLASS: "+ cl + " ======"
		for sr in source:
			nb = len(filter(lambda x:cl+'_'+sr+'_'+do in x, list_file))
			print sr + ': ' + str(nb)


#print do+': '+cl+'_'+sr+'='+str(P1_artcomment)
