    ...
    Dimension<List<Object>> getPipelineParameters()
    {
        ...
        return Dimension.create(
                ...
                Arrays.asList(new Object[] {
                        ...
                        10000, LuceneSkipNgramFeatureExtractorBase.PARAM_NGRAM_MIN_N, 2,
                        LuceneSkipNgramFeatureExtractorBase.PARAM_NGRAM_MAX_N, 2,
                        LuceneSkipNgramFeatureExtractorBase.PARAM_NGRAM_USE_TOP_K, 10000,
