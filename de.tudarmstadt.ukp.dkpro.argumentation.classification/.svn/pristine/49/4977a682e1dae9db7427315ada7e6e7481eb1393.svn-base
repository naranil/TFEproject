...
/**
 * @author Copied from the {@link de.tudarmstadt.ukp.dkpro.tc.features.syntax} package
 * @return The ratio of each universal POS tags to the total number of tags
 */
